						...
						<div class="accordion-group">
							<div class="accordion-heading">
								<a href="#collapseFive" data-parent="#side_accordion"
									data-toggle="collapse" class="accordion-toggle"> <i
									class="icon-folder-close"></i> <spring:message code="nav.user" />
								</a>
							</div>
							<div class="accordion-body collapse" id="collapseFive">
								<div class="accordion-inner">
									<ul class="nav nav-list">
										<li
											class='<c:if test="${fn:endsWith(requestURL, '/user/usermanage')}">active</c:if>'><a
											href="<c:url value="/user/usermanage" />"><spring:message
													code="nav.user.usermanage" />
										</a>
										</li>
										<li
											class='<c:if test="${fn:endsWith(requestURL, '/user/rolemanage')}">active</c:if>'><a
											href="<c:url value="/user/rolemanage" />"><spring:message
													code="nav.user.rolemanage" />
										</a>
										</li>
										<li
											class='<c:if test="${fn:endsWith(requestURL, '/user/authorities')}">active</c:if>'><a
											href="<c:url value="/user/authorities" />"><spring:message
													code="nav.user.authorities" />
										</a>
										</li>
									</ul>
								</div>
