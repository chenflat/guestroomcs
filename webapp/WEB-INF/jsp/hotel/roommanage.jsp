	...
	<c:if test="${totalRooms==0}">
		...
		<form id="initRoom" class="stepy-wizzard form-horizontal"
			...
			<fieldset title="客房定义 - 初始化参数">
				...
				<div class="control-group">
					...
					<div class="controls">
						<label class="switch"> <input type="checkbox"
							id="removeFloorNum" name="removeFloorNum" checked="checked" /> <span>On</span>
						</label>
					</div>
				</div>
				<div class="control-group">
				...
				<select name="chosen_a" id="chosen_a"
					data-placeholder="客房类型" class="chzn_a">
					<option value=""></option>
...
<!-- 删除提示 -->
<%@ include file="room_delete.jsp" %>
<!-- 批量新增 -->
<%@ include file="room_batchadd.jsp" %>
<!-- 批量新增 -->
<%@ include file="room_group.jsp" %>
