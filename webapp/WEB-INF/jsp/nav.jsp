			...
			<ul class="nav user_menu pull-right">
				...
				<li class="dropdown"><a href="#"
					...
					<ul class="dropdown-menu">
						<li><a href="#"><i class="icon-wrench"></i> 系统管理</a>
						</li>
						<li><a href="<c:url value="/hotel" />"><i
								class="icon-star"></i> 酒店管理</a>
						</li>
						<li><a href="<c:url value="/guest" />"><i
								class="icon-map-marker"></i> 客人管理</a>
						</li>
						<li><a href="<c:url value="/user" />"><i
								class="icon-user"></i> 用户管理</a>
						</li>
						<li><a href="<c:url value="/handover" />"><i
								class="icon-thumbs-up"></i> 交接班管理</a>
						</li>
				...
				<ul class="nav">
					<li class="dropdown"><a data-toggle="dropdown"
						...
						<ul class="dropdown-menu">
							...
							<li class="divider"></li>
							<li class="dropdown sub-dropdown dropdown-submenu"><a
								href="#">Guest Preferences<b class="caret-right"></b>
							</a>
								<ul class="dropdown-menu sub-menu">
									<li><a href="#">Sub menu 1.1</a>
									</li>
							...
							<li class="dropdown sub-dropdown dropdown-submenu"><a
								href="#">Room Status<b class="caret-right"></b>
							</a>
								<ul class="dropdown-menu sub-menu">
									<li><a href="#">Sub menu 1.1</a>
									</li>
							...
							<li class="divider"></li>
							<li class="dropdown sub-dropdown dropdown-submenu"><a
								href="#">HVAC<b class="caret-right"></b>
							</a>
								<ul class="dropdown-menu sub-menu">
									<li><a href="#">Sub menu 1.1</a>
									</li>
