		...
		<form:form modelAttribute="role" method="post"
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<span class="help-inline"><form:errors path="roleName" /> </span>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					...
					<span class="help-inline"><form:errors path="roleDesc" /> </span>
				</div>
			</div>
			...
			<ul class="nav nav-list" id="resource-tree">
				<c:forEach items="${resources}" var="res" varStatus="status">
					<li id="resource_${res.resourceId}"><input type="checkbox" name="resourcelist[${status.index}].resourceId"  value="${res.resourceId}" />  ${res.resourceName}
					</li>
				</c:forEach>
			</ul>
