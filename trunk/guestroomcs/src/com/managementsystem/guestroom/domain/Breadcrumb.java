package com.managementsystem.guestroom.domain;

public class Breadcrumb {
	private static final int maxLinkNameLength = 35; // Max number of characters
														// that a breadcrumb
														// link can have
	...
	/**
	 * Enforce a maximum string length, e.g. "Test String" shortened to
	 * "Test S..." if too long!
	 * 
	 * @param linkName
	 *            String to shorten
