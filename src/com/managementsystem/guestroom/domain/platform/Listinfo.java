...
public class Listinfo implements java.io.Serializable {
	...
	public Listinfo(String entryid, Listinfo lists, String listname, String text,
	...
	public Listinfo getLists() {
		return this.lists;
	}

	public void setLists(Listinfo lists) {
		this.lists = lists;
	}
	...
	public String getDisplayName() {
		displayName = "";
		if (lists != null) {
			displayName = lists.getListname() + ":";
		}
		displayName += this.getListname();
		return displayName;
	}
